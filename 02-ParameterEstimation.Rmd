...
as a Bernoulli trial.  You can think of any <i>single</i> trial with two possible outcomes as a Bernoulli trial. The Bernoulli distribution is the probability distribution of Bernoulli trials, basically a model of the coin flip.  
...
```{r 2coins, echo = TRUE, warning=FALSE, message=FALSE, cache = TRUE, fig.cap = 'Bias of Two Coins: Theta 1'}
a = 2
b = 2
...
```{r bern_change_point, echo = TRUE, warning=FALSE,message=FALSE, cache = TRUE}
